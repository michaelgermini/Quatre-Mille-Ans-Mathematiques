...
LÉGENDE :
⭐ = Aldébaran (étoile brillante orange)
★ = Zénith (point directement au-dessus)
│ = Méridien céleste (ligne Nord-Sud)
73.2° = Angle de hauteur (altitude)
```
...
EXPLICATION :
- L'étoile est à +16.5° au-dessus de l'équateur céleste (δ)
- Bagdad est à 33.3° Nord (φ)
- Le pôle céleste est à 90° - 33.3° = 56.7° de hauteur
- Hauteur finale : 56.7° + 16.5° = 73.2°
```
...
COORDONNÉES D'ALDÉBARAN :
- Ascension droite (α) : 69° (position Est-Ouest)
- Déclinaison (δ) : +16.5° (position Nord-Sud)
- Hauteur (h) : 73.2° (angle depuis horizon)
- Azimut (A) : 180° (plein Sud à la culmination)
```
